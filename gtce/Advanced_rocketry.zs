...
val gt_advanced_thruster = <ore:rotorStainlessSteel>;
val gt_circuit_board = <metaitem:board.plastic>;
val gt_datastick = <metaitem:tool.datastick>;
val gt_display = <minecraft:glass>;
...
//Battery
assembler.recipeBuilder()
	.inputs(<ore:plateBatteryAlloy> * 4)
...
recipes.addShaped("ar_motor_elite", <libvulpes:elitemotor>, 
    [[null, <ore:plateTungstenSteel>, <ore:plateTungstenSteel>],
...
recipes.addShaped("ar_railgun", <advancedrocketry:railgun>, 
    ...
    [<ore:plateSteelMagnetic>, gt_hv_machine_hull, <ore:plateSteelMagnetic>],
    [<ore:plateSteelMagnetic>, <ore:circuitAdvanced>, <ore:plateSteelMagnetic>]]);
...
chemical_reactor.recipeBuilder()
	.fluidInputs([<liquid:oxygen> * 10 ])
	.fluidInputs([<liquid:hydrogen> * 10 ] )
	.fluidOutputs(<liquid:rocketfuel> * 1)
	.EUt(64)
	.duration(50)
	.buildAndRegister();
